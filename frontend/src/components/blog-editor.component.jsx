...
const BlogEditor = () => {
  ...
  const handleBannerUpload = (e) => {
    ...
    if (img) {
      let loadingTost = toast.loading("Uploding...");
      UploadImage(img)
        .then((url) => {
          if (url) {
    ...
    <>
      <nav className="navbar">
        ...
        <div className="flex gap-4 ml-auto">
          <button className="btn-dark py-2" onClick={handlePubishEvent}>
            publish
          </button>
          <button className="btn-light py-2" onClick={handleSaveDaraft}>
            Save Draft
          </button>
        </div>
      </nav>
