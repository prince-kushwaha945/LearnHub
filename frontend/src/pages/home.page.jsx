...
const HomePage = ( ) => {
  ...
  const fetchBlogsByCategoty = ( { page = 1}) => {
    axios
        ...
        <div className="f-full ">
          ...
          >
            <>
              ...
              <LoadMoreDataBtn state={blogs} fetchDataFun={( pageState == "home" ? fetchLatesBlogs : fetchBlogsByCategoty )} />
            </>
