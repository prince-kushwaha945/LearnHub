  ...
  return (
    <section className="h-cover flex justify-center gap-10 ">
      <div className="w-full">
        ...
        <div className="min-w-[40%] lg:min-w-[350px] max-w-min border-1 border-grey pl-8 pt-10 max-md:hidden" >
          <h1 className="font-medium text-xl mb-8 ">User Relate to search <i className="fi fi-rr-user mt-1"></i></h1>
